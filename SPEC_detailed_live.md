...
- Server-authoritative simplified racing physics: throttle, brake, steering, per-driver setup multipliers, optional warm-up/flying start timing, velocity-based lateral slip, aero/speed drag, downforce-style speed-building grip, optional gentle stability assist, tuned surface grip/drag, rain grip reduction, wall slowdown, directional car contact/crash handling, optional crash/off-track reset, checkpoint-gated lap finish, DNF handling, and results.
