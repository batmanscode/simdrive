...
- Elevated terrain: Fjord/Cloudline use generated terrain support, not a full terrain engine. If layout points change and players see road fading into grass, floating sky gaps, grass stripes, or false tunnels/walls, rerun the terrain conflict audit and check same-height terrain panels near overlapping route sections.
